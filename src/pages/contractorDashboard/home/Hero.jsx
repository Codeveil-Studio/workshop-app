...
export default function Hero() {
  return (
    <div className="bg-gradient-to-r from-green-50 to-white rounded-xl p-4 sm:p-6 mb-6 flex flex-col sm:flex-row items-center justify-between shadow-sm gap-4">
      <div className="flex-1 text-center sm:text-left">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">Create & Search Work Easily</h2>
