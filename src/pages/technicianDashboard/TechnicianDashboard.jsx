      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white shadow-sm sticky top-0 z-30">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="inline-flex items-center gap-2 bg-[var(--primary)] hover:bg-blue-600 text-white px-3 py-2 rounded-md shadow-sm text-sm"
          >
            <IconPlus />
            Create
          </button>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              ...
              <div className="text-xs text-gray-400">you@example.com</div>
            </div>
            <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-[#29cc6a] font-semibold">T</div>
          </div>
        </div>
      </header>
